    ...
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        ...
        onClick={()=> handleEditarCantidades(producto.id)}
          type="button"
          className="bg-sky-700 flex gap-2 p-5 py-2 text-white rounded-md font-bold uppercase shadow-sm w-full "
        >
          <svg
        ...
        onClick={()=> handleEliminarProducto(producto.id)}
          type="button"
          className="bg-red-700 flex gap-2 p-5 py-2 text-white rounded-md font-bold uppercase shadow-sm w-full mt-3"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
